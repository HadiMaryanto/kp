    ...
    <div class="col-md-12">
        <div class="panel panel-default" style="padding: 15px;">
            <div class="panel-body">
                <?php echo form_open('Asnaf/edit'); ?>

               <div class="form-group">
                                    <label>Id Asnaf</label>
                                    <input type="text" readonly name="id_asnaf" class="form-control"  value="<?php echo $record['id_asnaf']?>">
                                </div>

                <div class="form-group">
                <label>Kategori Asnaf</label>
                <input type="text" name="nama_asnaf" class="form-control" required value="<?php echo $record['nama_asnaf']?>">
