    ...
    <div class="col-md-12">
        <div class="panel panel-default" style="padding: 15px;">
            <div class="panel-body">
                <?php echo form_open('Program/edit'); ?>

               <div class="form-group">
                                    <label>Id Program</label>
                                    <input type="text" readonly name="id_program" class="form-control"  value="<?php echo $record['id_program']?>">
                                </div>

                <div class="form-group">
                <label>Nama Program</label>
                <input type="text" name="nama_program" class="form-control" required value="<?php echo $record['nama_program']?>">
