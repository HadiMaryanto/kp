    ...
    <div class="col-md-12">
        <div class="panel panel-default" style="padding: 15px;">
            <div class="panel-body">
                <?php echo form_open('Rekening/edit'); ?>

               <div class="form-group">
                                    <label>Id Rekening</label>
                                    <input type="text" readonly name="id_rek" class="form-control" readonly  value="<?php echo $record['id_rek']?>">
                                </div>
                ...
                <input type="text" name="nama_bank" class="form-control" required value="<?php echo $record['nama_bank']?>">
                 ...
                 <input type="text" name="no_rek" class="form-control" required value="<?php echo $record['no_rek']?>">
                  ...
                  <div class="form-group">
                  <label>Saldo</label>
                  <input type="text" name="saldo" class="form-control" required value="<?php echo $record['saldo']?>">

                   </div>

                   <div class="form-group">
                   <label>Tanggal Aktivasi</label>
                   <input type="date" name="tgl_aktivasi" class="form-control" required value="<?php echo $record['tgl_aktivasi']?>">
